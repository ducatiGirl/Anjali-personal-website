        ...
        <div className="punyam-container">
            ...
            <section className="project-section">
                ...
                <div className="process-phase">
                    ...
                    <p>I started with a blank page, sketching out user flows and wireframes. I knew the user experience had to be seamless and intuitive, so I focused on creating a clear journey for claiming wishes and watching the tree ripen.</p>
                </div>
                <div className="process-phase">
                    <h3>Phase 2: Bringing it to Life</h3>
                    <p>I chose **React** for the front end because I wanted a dynamic, responsive user interface. On the back end, I paired **Node.js with MongoDB** for its flexibility, allowing me to easily handle all the data for user profiles and the status of each mango. The real-time "giving tree" visualization was the heart of the project, and I loved using **Styled-Components** to give it that organic, living feel.</p>
                </div>
                <div className="process-phase">
